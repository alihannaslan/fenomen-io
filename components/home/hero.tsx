        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 text-sm">
                ...
                Yeni: Creator AI Asistanı aktif
              </Badge>
            </motion.div>
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                AI ile içerik <strong>üretimini</strong> <br />
                <em className="italic">büyüt</em>
              </h1>
            </motion.div>
            ...
            >
              Fenomen, influencerlar için yapay zeka destekli profil analizi ve büyüme asistanı. Hesabını tarar, güçlü
              ve zayıf yönlerini tespit eder, büyüme önerileri sunar.
            </motion.p>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="#features">
                  <button className="px-6 py-3 rounded-full border border-border bg-background hover:bg-card text-foreground font-medium transition-all">
                    Profilini Analiz Et
                  </button>
                </a>
              </div>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">TikTok ve Instagram içerik üreticilerinin tercihi</p>
