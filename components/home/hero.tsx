...
export default function Hero() {
  ...
  return (
    <section
      ...
      aria-label="Influencer & Creator Analiz Hero"
    >
      <div className="container relative z-10 mx-auto flex flex-1 flex-col px-4 py-24 sm:py-32">
        <div className="mx-auto flex max-w-4xl flex-1 flex-col justify-center text-center">
          {/* Badge */}
      <motion.div
...
>
  <Badge
    // outline + beyaz arka plan + koyu yazı
    variant="outline"
    className="bg-white !bg-white text-gray-900 dark:text-gray-900 border border-border inline-flex items-center gap-2 px-4 py-2 text-sm"
  >
    <Sparkles className="h-4 w-4" />
    Yeni: TikTok & Instagram Analizi
  </Badge>
</motion.div>
          ...
          >
            ...
            >
              <span className="block">Influencer & Creator</span>
              <span className="block">
                analiziyle <strong>hızlı büyü</strong>
              </span>
              <span className="block">
                <em className="italic">— Yapay Zeka ile</em>
              </span>
            </h1>
          </motion.div>
          ...
          >
            Profil linkini ekle; son 90 gün içeriğini tarayalım. Hangi{" "}
            <strong>hook</strong>’ların çalıştığını, ideal yayın sıklığını ve
            tahmini büyüme yol haritanı net adımlarla gösterelim.
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center justify-center">
              <Link href="/signup" prefetch={false} aria-label="Ücretsiz analize başla">
        ...
        >
          <div className="text-center">
            <p className="mb-6 text-sm text-muted-foreground">Altyapıda güvendiğimiz teknolojiler</p>
            <div className="flex items-center justify-center gap-8">
              {/* Vercel */}
              <div className="opacity-60 grayscale transition-all duration-300 hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 512 512"
              ...
              {/* Tailwind */}
              <div className="opacity-60 grayscale transition-all duration-300 hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(56,189,248,0.5)]">
                <img
