      ...
      <div className="mx-auto max-w-4xl rounded-[40px] border border-black/5 dark:border-white/20 p-2 shadow-sm">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(231, 138, 83, 0.15), transparent 70%)",
            }}
          />
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Yeni: Creator AI Asistanı Şimdi Aktif</h2>
              <p className="text-white/60 mb-8">Fenomen artık içerik fikirlerini otomatik olarak öneriyor</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
              ...
              <div className="flex items-center justify-center">
                <a href="/signup">
                  <div className="group border-border bg-secondary/70 flex h-[64px] cursor-pointer items-center gap-2 rounded-full border p-[11px] mt-10 hover:shadow-lg transition-all">
