        ...
        <FollowerPointerCard
          title={
            <div className="flex items-center gap-2">
              <span>🤖</span>
              <span>Yapay zekâ ile büyümeyi hızlandır</span>
            </div>
          }
        >
          <div className="cursor-none">
            <div className="grid grid-cols-12 gap-4 justify-center">
              {/* 1) AI Profil Skoru & Denetim */}
              <motion.div
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">AI Profil Skoru & Denetim</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[520px]">
                      <b>fenomen</b>, TikTok/Instagram profilini 50+ sinyale göre tarar: bio, ER, tutma oranı, ritim,
                      kategori uyumu ve daha fazlası. Anında <b>profil skoru</b> ve güçlü/zayıf yönlerin.
                    </p>
                  </div>
                </div>

                <div className="pointer-events-none flex grow items-center justify-center select-none relative">
                  <div className="relative w-full h-[400px] rounded-xl overflow-hidden" style={{ borderRadius: "20px" }}>
                    {/* Background image (placeholder) */}
                    <div className="absolute inset-0">
                      <img
                        src="https://framerusercontent.com/images/UjqUIiBHmIcSH9vos9HlG2BF4bo.png"
                        alt="Profil denetimi görselleştirmesi"
                    ...
                    <motion.div
                      ...
                      initial={{ scale: 1 }}
                      animate={isCliHovering ? { scale: [1, 1.34, 1, 1.34] } : { scale: 1 }}
                      transition={{
                        duration: 3,
                        ease: "easeInOut",
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">AI Trend Radar (Küresel)</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[520px]">
                      Nişindeki yükselen formatları ve sesleri yapay zekâ ile yakala. “Şimdi çekilebilir” içerik
                      açıları, örnek brief ve CTA önerileriyle birlikte gelir.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex min-h-[300px] grow items-start justify-center select-none">
                  ...
                  <div className="absolute top-64 z-10 flex items-center justify-center">
                    <div className="w-[400px] h-[400px]">
                      <Suspense fallback={<div className="bg-secondary/20 h-[400px] w-[400px] animate-pulse rounded-full"></div>}>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Hook & Senaryo Üretici</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[520px]">
                      İlk 3 saniye için <b>AI hook</b>’ları, nişine uygun <b>kısa senaryolar</b> ve <b>CTA</b>’lar.
                      Tek tıkla çekime hazır metin.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                      <div className="p-4">
                        <textarea
                          ...
                          placeholder="@kullanici veya konu yaz… (Örn: cilt bakımı, akne rutini)"
                          value={inputValue}
                      ...
                      <div className="flex items-center justify-between px-4 pb-4">
                        <div className="flex items-center gap-3">
                          <button className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors" title="Fikir üret">
                        ...
                        <button className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors" title="Kaydet">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/70">
              ...
              {/* 4) Aylık AI Raporları & Yol Haritası */}
              <motion.div
                className="group border-secondary/40 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 p-6 shadow-xl transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-8"
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">
                    Aylık AI Raporları & Yol Haritası
                  </h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[520px]">
                      Her ay otomatik <b>AI raporu</b>: hedeflere göre ilerleme, haftalık <b>içerik planı</b>, KPI
                      takibi (ER, tutma, yorum/saved), <b>rakip kıyas</b> ve <b>marka-güven skoru</b>.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="relative w-full max-w-sm">
                    <img
                      ...
                      alt="Aylık AI raporu ve yol haritası"
