      ...
      {isAtBottom && (
        ...
        >
          ...
          >
            ...
            <motion.h2
              className="absolute bottom-0 left-0 translate-y-1/3 sm:text-[140px] text-[60px] font-bold select-none"
              style={{ color: "#121113" }}
            ...
            <motion.p
              className="absolute bottom-4 left-4 text-sm font-medium select-none"
              style={{ color: "#121113" }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 0.7 }}
              transition={{ duration: 0.8, delay: 0.5 }}
            >
              AI ile influencer büyüme asistanı
            </motion.p>
          </div>
        </motion.div>
      )}
